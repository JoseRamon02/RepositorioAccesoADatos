...
/**
 * El panel principal del juego que maneja la lógica del juego, incluyendo jugadores,
...
public class GamePanel extends JPanel implements Runnable, KeyListener {
    ...
    /**
     * Muestra el cuadro de diálogo con el ranking del juego.
     */
    private void mostrarRanking() {
        // Eliminar el KeyListener antes de mostrar el ranking
        removeKeyListener(this);

        // Crear un hilo para mostrar el cuadro de diálogo
        Thread dialogThread = new Thread(() -> {
            ranking = new RankingXML();
            String rankingInfo = ranking.obtenerRankingDesdeXML(); // Método que obtiene el ranking
    ...
    private void guardarPuntuacion() {
        ...
        ranking.setNombre(playerName); // Assuming playerName is a variable in your class
